...
hubIndex::
	...
	sed -e "s#genome.ucsc.edu/h/#genome-test.gi.ucsc.edu/h/#g; s/hgdownload.soe/hgdownload-test.gi/g; s#/${indexName}.html#/${testIndexName}.html#; s#${name}/${hubFile}.txt#${name}/${testHubFile}.txt#; s/${statsName}.html/${testStatsName}.html/; s#${dataName}.html#${testDataName}.html#;" ${destDir}/${indexName}.html > ${destDir}/${testIndexName}.html
...
asmStats::
	...
	sed -e "s#genome.ucsc.edu/h/#genome-test.gi.ucsc.edu/h/#g; s/hgdownload.soe/hgdownload-test.gi/g; s/${indexName}.html/${testIndexName}.html/; s#/${statsName}.html#/${testStatsName}.html#; s#${dataName}.html#${testDataName}.html#;" ${destDir}/${statsName}.html > ${destDir}/${testStatsName}.html
...
trackData::
	...
	${toolsDir}/trackData.pl -test ${Name} ${name} ${orderList} | sed -e "s#${indexName}.html#${testIndexName}.html#; s#${statsName}.html#${testStatsName}.html#; s#${dataName}.html#${testDataName}.html#;" > ${destDir}/${testDataName}.html
