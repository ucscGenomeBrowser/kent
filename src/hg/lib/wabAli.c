...
fputc(sep,f);
fprintf(f, "%u", el->milliScore, sep);
fputc(sep,f);
fprintf(f, "%u", el->symCount, sep);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->qSym, sep);
if (sep == ',') fputc('"',f);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->tSym, sep);
if (sep == ',') fputc('"',f);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->hSym, lastSep);
if (sep == ',') fputc('"',f);
fputc(lastSep,f);
}
