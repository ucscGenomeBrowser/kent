...
"    {\n"
"    seriousError next;	// Next in exception chain\n"
...
"    {\n"
"    }\n"
"global flow punt(string message, string source=\"application\", int errno=-1);\n"
"global flow puntMore(string message, string source=\"application\", \n"
"                int errno=-1);\n"
"global flow throw(seriousError e);\n"
"global flow throwMore(seriousError e);\n"
"\n"
"global class winApp\n"
"    {\n"
"    polymorphic to open();\n"
