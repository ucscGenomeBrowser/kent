...
"Someone who submits files to or otherwise interacts with big data warehouse"
    ...
    char[64] sid unique;       "sha384 generated user ID - used to identify user in secure way if need be"
...
"A file that has been uploaded, the format checked, and for which at least minimal metadata exists"
    ...
    string format index;    "What format it's in from manifest"
    string outputType index; "What output_type it is from manifest"
    string experiment index; "What experiment it's in from manifest"
