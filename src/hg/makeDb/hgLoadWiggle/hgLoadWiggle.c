...
static char const rcsid[] = "$Id: hgLoadWiggle.c,v 1.3 2003/11/06 20:31:17 hiram Exp $";
...
if (sqlTable != NULL)
    ...
    dyStringAppend(dy, "  average double not null,\n");
    dyStringAppend(dy, "  stddev double not null,\n");
