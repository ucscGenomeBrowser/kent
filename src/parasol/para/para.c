...
errAbort(
  ...
  "         If needed, use a priority flag with make, push, create, shove, or try.\n"
  "         Alternatively, set batch priority to a specific numeric value - default %d \n"
  "         1 is emergency high priority, %d is normal medium, %d is low for bottomfeeders.\n"
  "         Setting priority higher than normal (1-%d) will be logged by the system.\n"
  "         Note: Please keep low priority jobs short because they won't be pre-empted.\n"
  "para try \n"
  ...
  "para priority 999\n"
  "   Set batch priority. See description of priority values under 'push' above.\n"
  "\n"
  "Common options\n"
