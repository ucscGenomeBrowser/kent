/* output/polyTest.c was originally generated by the autoSql program, which also 
 * generated output/polyTest.h and output/polyTest.sql.  This module links the database and
