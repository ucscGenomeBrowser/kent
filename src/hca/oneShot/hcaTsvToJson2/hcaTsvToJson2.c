...
void hcaTsvToJson2(char *inTab, char *outDir)
/* hcaTsvToJson2 - Convert HCA flavored tab-separated-values to HCA flavored JSON. */
{
static char *requiredFields[] = {"project.id", "assay.files.name", "sample.donor.species", "assay.single_cell.method"};
