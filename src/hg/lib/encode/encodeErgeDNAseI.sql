# encodeErgeDNAseI.sql was originally generated by the autoSql program, which also 
# generated encodeErgeDNAseI.c and encodeErgeDNAseI.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#ENCODE experimental data from dbERGEII
CREATE TABLE encodeErgeDNAseI (
    bin int,
