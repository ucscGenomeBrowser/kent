...
pfc->strType = pfScopeAddType(scope, "string", TRUE, pfc->streamType, sizeof(_pf_String), TRUE);
pfc->strType->keyedBy = pfc->longType;
pfc->dyStrType = pfScopeAddType(scope, "dyString", TRUE, pfc->strType, sizeof(_pf_String), TRUE);
pfc->dyStrType->keyedBy = pfc->longType;
...
pfc->dirType->keyedBy = pfc->strType;
