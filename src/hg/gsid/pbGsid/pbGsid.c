/* pbGsid.c - GSID Proteome Browser main cgi script. */
#include "common.h"
#include "hCommon.h"
#include "portable.h"
#include "jksql.h"
...
#include "hui.h"
#include "spDb.h"
#include "../../inc/pbStamp.h"
#include "../../protein/inc/pbStampPict.h"
#include "../../protein/inc/pbTracks.h"
#include "trashDir.h"
#include "psGfx.h"

static char const rcsid[] = "$Id: pbGsid.c,v 1.2.18.1 2008/08/05 07:11:13 markd Exp $";
...
if (proteinInSupportedGenome)
    ...
    {
    hPrintf("<TD ALIGN=Right><A HREF=\"../goldenPath/help/pbTracksHelpFiles/pbGsid/pbTracksHelp.shtml\" TARGET=_blank>%s</A></TD>",
        wrapWhiteFont("Help"));
    }
