...
<?php global $wgScriptPath; if ( strlen($wgScriptPath) == 0 ) { ?>
		<tr>
			<td COLSPAN=2>NOTE: Any content you enter into
genomewiki<BR>is public content and can not be removed.</td>
		</tr>
<?php } else { ?>
		<tr>
			<td COLSPAN=2>NOTE: This is a private wiki.<BR>Account
creation upon request only.</td>
		</tr>
<?php } ?>
	</table>
