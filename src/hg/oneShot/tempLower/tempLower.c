...
static char const rcsid[] = "$Id: tempLower.c,v 1.2 2003/05/06 07:22:31 kate Exp $";
...
errAbort(
  "tempLower - Remove centromeres etc. from oo.18 cytobands\n"
  "usage:\n"
  "   tempLower in.bed inserts out.bed\n");
}
...
if (argc != 4)
    usage();
tempLower(argv[1], argv[2], argv[3]);
return 0;
}
