...
CREATE TABLE stsInfo (
    ...
    genbank longblob not null,	# Related GeneBank accessions
    gdbCount int unsigned not null,	# Number of related GDB identifiers
    gdb longblob not null,	# Related GDB identifies
    nameCount int unsigned not null,	# Number of alias names
    otherNames longblob not null,	# Alias names
    ...
    otherDbSTS longblob not null,	# Related dbSTS IDs
    leftPrimer varchar(255) not null,	# 5' primer sequence
    rightPrimer varchar(255) not null,	# 3' primer sequence
    ...
    marshfieldName varchar(255) not null,	# Name in Marshfield map
    marshfieldChr varchar(255) not null,	# Chromosome in Marshfield map
    marshfieldPos float not null,	# Position in Marshfield map
    marshfieldLOD float not null,	# LOD score in Marshfield map
    wiyacName varchar(255) not null,	# Name in WI YAC map
    wiyacChr varchar(255) not null,	# Chromosome in WI YAC map
    wiyacPos float not null,	# Position in WI YAC map
    wiyacLOD float not null,	# LOD score in WI YAC map
    wirhName varchar(255) not null,	# Name in WI RH map
    wirhChr varchar(255) not null,	# Chromosome in WI RH map
    wirhPos float not null,	# Position in WI RH map
    wirhLOD float not null,	# LOD score in WI RH map
    gm99gb4Name varchar(255) not null,	# Name in GeneMap99 GB4 map
    gm99gb4Chr varchar(255) not null,	# Chromosome in GeneMap99 GB4 map
    gm99gb4Pos float not null,	# Position in GeneMap99 GB4 map
    gm99gb4LOD float not null,	# LOD score in GeneMap99 GB4 map
    gm99g3Name varchar(255) not null,	# Name in GeneMap99 G3 map
    gm99g3Chr varchar(255) not null,	# Chromosome in GeneMap99 G3 map
    gm99g3Pos float not null,	# Position in GeneMap99 G3 map
    gm99g3LOD float not null,	# LOD score in GenMap99 G3 map
    tngName varchar(255) not null,	# Name in Stanford TNG map
    tngChr varchar(255) not null,	# Chromosome in Stanford TNG map
