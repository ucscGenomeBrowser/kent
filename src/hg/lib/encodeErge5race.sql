# encodeErge5race.sql was originally generated by the autoSql program, which also 
# generated encodeErge5race.c and encodeErge5race.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#ENCODE experimental data from dbERGEII
CREATE TABLE encodeErge5race (
    bin int,
