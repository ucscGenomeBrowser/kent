 ...
 * If worried about this use vgPrbAliSaveToDbEscaped() */

void vgPrbAliSaveToDbEscaped(struct sqlConnection *conn, struct vgPrbAli *el, char *tableName, int updateSize);
/* Save vgPrbAli as a row to the table specified by tableName. 
 * As blob fields may be arbitrary size updateSize specifies the approx size.
 * of a string that would contain the entire query. Automatically 
 * escapes all simple strings (not arrays of string) but may be slower than vgPrbAliSaveToDb().
