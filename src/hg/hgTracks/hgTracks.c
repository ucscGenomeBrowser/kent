...
static char const rcsid[] = "$Id: hgTracks.c,v 1.582.2.1 2003/08/19 17:49:39 hiram Exp $";
...
if (cgiVarExists("hgt.reset"))
    resetVars();
cartHtmlShell("UCSC Genome Browser v31", doMiddle, hUserCookie(), excludeVars, NULL);
return 0;
}
