# stsInfo2.sql was originally generated by the autoSql program, which also 
# generated stsInfo2.c and stsInfo2.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#Constant STS marker information - revision
CREATE TABLE stsInfo2 (
    ...
    dbSTSid int unsigned,	# ID number in UniSTS or dbSTS
    ...
    genethonPos float,	# Position in Genethon map
    genethonLOD float,	# LOD score in Genethon map
    marshfieldName varchar(255),	# Name in Marshfield map
    marshfieldChr varchar(255),	# Chromosome in Marshfield map
    marshfieldPos float,	# Position in Marshfield map
    marshfieldLOD float,	# LOD score in Marshfield map
    wiyacName varchar(255),	# Name in WI YAC map
    wiyacChr varchar(255),	# Chromosome in WI YAC map
    wiyacPos float,	# Position in WI YAC map
    wiyacLOD float,	# LOD score in WI YAC map
    wirhName varchar(255),	# Name in WI RH map
    wirhChr varchar(255),	# Chromosome in WI RH map
    wirhPos float,	# Position in WI RH map
    wirhLOD float,	# LOD score in WI RH map
    gm99gb4Name varchar(255),	# Name in GeneMap99 GB4 map
    gm99gb4Chr varchar(255),	# Chromosome in GeneMap99 GB4 map
    gm99gb4Pos float,	# Position in GeneMap99 GB4 map
    gm99gb4LOD float,	# LOD score in GeneMap99 GB4 map
    gm99g3Name varchar(255),	# Name in GeneMap99 G3 map
    gm99g3Chr varchar(255),	# Chromosome in GeneMap99 G3 map
    gm99g3Pos float,	# Position in GeneMap99 G3 map
    gm99g3LOD float,	# LOD score in GenMap99 G3 map
    tngName varchar(255),	# Name in Stanford TNG map
    tngChr varchar(255),	# Chromosome in Stanford TNG map
    tngPos float,	# Position in Stanford TNG map
    tngLOD float,	# LOD score in Stanford TNG map
    decodeName varchar(255),	# Name in deCODE map
    decodeChr varchar(255),	# Chromosome in deCODE TNG map
    decodePos float,	# Position in deCODE TNG map
    decodeLOD float,	# LOD score in deCODE TNG map
              #Indices
    PRIMARY KEY(identNo)
);
