...
static char const rcsid[] = "$Id: nibbNameFix.c,v 1.1 2005/11/08 16:20:57 kent Exp $";
...
errAbort(
  "nibbNameFix - Regularize format of NIBB sequence names\n"
  "usage:\n"
  "   nibbNameFix old.fa old.psl new.fa new.psl\n"
  "options:\n"
  "   -xxx=XXX\n"
  );
}
...
void nibbNameFix(char *oldFa, char *oldPsl, char *newFa, char *newPsl)
/* nibbNameFix - Regularize format of NIBB sequence names. */
{
