...
if ( -e GitReports.ok ) then
    ...
    echo "Ready for pairings, day 9, Git reports completed for v${BRANCHNN} review http://genecats.cse.ucsc.edu/git-reports/ (history at http://genecats.cse.ucsc.edu/git-reports-history/)." | mail -s "Ready for pairings (day 9, v${BRANCHNN} review)." $USER donnak kuhn ann pauline
else
