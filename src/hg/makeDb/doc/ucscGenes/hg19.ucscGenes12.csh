...
#	"$Id: hg19.ucscGenes12.csh,v 1.8 2009/11/02 16:17:21 kent Exp $"

# Directories
set genomes = /hive/data/genomes
set dir = $genomes/hg19/bed/ucsc.12
...
# Previous gene set
set oldGeneBed = $genomes/hg19/bed/ucsc.12/oldUcscGenes.bed
# This was created with:
# zcat /cluster/data/hg18/bed/liftOver/hg18ToHg19.over.chain.gz | liftOver /cluster/data/hg18/bed/ucsc.11/ucscGenes.bed stdin oldUcscGenes.bed oldUcscGenes.unmapped
...
# CPU time in finished jobs:       2118s      35.29m     0.59h    0.02d  0.000 y
# IO & Wait Time:                   334s       5.57m     0.09h    0.00d  0.000 y
...
# Lift over the old known genes from hg18 to hg19.
...
mkdir $genomes/hg19/bed/ucsc.12/pfam
cd $genomes/hg19/bed/ucsc.12/pfam
mkdir splitProt
...
cut -f 1,4 ucscPfam.tab | subColumn 2 stdin pfam/sub.tab stdout | sort -u > knownToPfam.tab
rm -f pfam/sub.tab
