...
static char const rcsid[] = "$Id: hgTracks.c,v 1.586.2.1 2003/08/28 18:08:02 heather Exp $";
...
if (cgiVarExists("hgt.reset"))
    resetVars();
cartHtmlShell("UCSC Genome Browser v32", doMiddle, hUserCookie(), excludeVars, NULL);
return 0;
}
