# gencodeToUniProt.sql was originally generated by the autoSql program, which also 
# generated gencodeToUniProt.c and gencodeToUniProt.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#GENCODE transcript to UniProt peptide mapping
CREATE TABLE gencodeToUniProt (
