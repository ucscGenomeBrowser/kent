 ...
 * generated stsAlias.c and stsAlias.sql.  This header links the database and the RAM 
...
/* List of aliases for STS files */
    ...
    char *alias;	/* This specific alias */
    char *trueName;	/* True in our stsMarker table */
    };
