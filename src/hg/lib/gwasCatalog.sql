...
CREATE TABLE gwasCatalog (
    ...
    pubDate date not null,		-- Date of publication
    ...
    replSample varchar(255) not null,	-- Replication sample size
    region varchar(255) not null,	-- Chromosome band / region of SNP
    genes varchar(255) not null,	-- Reported Gene(s)
    riskAllele varchar(255) not null,	-- Strongest SNP-RiskAllele
