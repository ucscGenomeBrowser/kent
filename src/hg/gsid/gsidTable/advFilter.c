...
static char const rcsid[] = "$Id: advFilter.c,v 1.4 2007/11/04 01:50:11 fanhsu Exp $";
...
hPrintf("to the main Table View page with the current filter settings applied.");
bigButtons();
