...
get_ipython().system(u' echo This cronjob pulls out GB stats over the last month, across all RR machines and Asia/Euro mirrors using the generateUsageStats.py script. It only counts each hgsid occurrence once, filtering our any hgsid that only showed up one time.')

get_ipython().system(u' echo')
get_ipython().system(u' echo List of db usage:')
get_ipython().system(u" echo db$'\\t'dbUse")
get_ipython().system(u' echo --------------------------------------------------------------------------------------')
...
get_ipython().system(u' head -n 15 /hive/users/"$USER"/ErrorLogsOutput/dbCounts.tsv.sorted | ~markd/bin/tabFmt')

get_ipython().system(u' echo')
get_ipython().system(u' echo "List of default track usage for hg38, sorted by how many users are turning off the track:"')
get_ipython().system(u" echo db$'\\t'trackUse$'\\t'% using$'\\t'% turning off$'\\t'trackName")
get_ipython().system(u' echo --------------------------------------------------------------------------------------')

get_ipython().system(u' grep ^hg38 /hive/users/"$USER"/ErrorLogsOutput/defaultCounts.tsv | grep -v "MarkH3k27ac" | sort -nrk 5 | awk -v OFS="\\t" \'{ print $1,$3,$4,$5,$2 }\' | head -n 15 | ~markd/bin/tabFmt')

get_ipython().system(u' echo')
get_ipython().system(u' echo "List of default track usage for hg19, sorted by how many users are turning off the track:"')
get_ipython().system(u" echo db$'\\t'trackUse$'\\t'% using$'\\t'% turning off$'\\t'trackName")
get_ipython().system(u' echo --------------------------------------------------------------------------------------')

get_ipython().system(u' grep ^hg19 /hive/users/"$USER"/ErrorLogsOutput/defaultCounts.tsv | grep -v "MarkH3k27ac" | sort -nrk 5 | awk -v OFS="\\t" \'{ print $1,$3,$4,$5,$2 }\' | head -n 15| ~markd/bin/tabFmt')

get_ipython().system(u' echo')
get_ipython().system(u' echo List of non-default track usage:')
get_ipython().system(u" echo db$'\\t'trackUse$'\\t'trackName")
get_ipython().system(u' echo --------------------------------------------------------------------------------------')
...
get_ipython().system(u' head -n 15 /hive/users/"$USER"/ErrorLogsOutput/trackCounts.tsv.sorted.noDefaults | awk -v OFS="\\t" \'{ print $1,$3,$2 }\' | ~markd/bin/tabFmt')

get_ipython().system(u' echo')
get_ipython().system(u' echo "List of public hub usage (only most used track represented):"')
get_ipython().system(u" echo db$'\\t'trackUse$'\\t'track$'\\t'pubHub")
get_ipython().system(u' echo --------------------------------------------------------------------------------------')
...
get_ipython().system(u' cat /hive/users/"$USER"/ErrorLogsOutput/filteredHubs.txt | awk -F "\\t" -v OFS="\\t" \'{ print $2,$4,$3,$1 }\' | ~markd/bin/tabFmt')

get_ipython().system(u' echo')
get_ipython().system(u' echo List of public hub track usage overall:')
get_ipython().system(u" echo db$'\\t'trackUse$'\\t'track$'\\t'pubHub")
get_ipython().system(u' echo --------------------------------------------------------------------------------------')

get_ipython().system(u' head -n 15 /hive/users/"$USER"/ErrorLogsOutput/trackCountsHubs.tsv.sorted | awk -F "\\t" -v OFS="\\t" \'{ print $2,$4,$3,$1 }\' | ~markd/bin/tabFmt')
...
get_ipython().system(u' head -n 1000 /hive/users/"$USER"/ErrorLogsOutput/nonPublicHubTracksPopularity.txt > /hive/users/"$USER"/ErrorLogsOutput/nonPublicHubTracksPopularityTop1000.txt')
...
get_ipython().system(u' echo')
get_ipython().system(u' echo "List of hub uses that are Not public hubs. Some public hubs sneak in due to alternative mirror or hubUrl:"')
get_ipython().system(u" echo db$'\\t'machine$'\\t'trackUse$'\\t'shortLabel$'\\t'hubUrl")
get_ipython().system(u' echo --------------------------------------------------------------------------------------')

get_ipython().system(u' cat /hive/users/"$USER"/ErrorLogsOutput/hubsNotPublic.txt | ~markd/bin/tabFmt')
...
get_ipython().system(u' echo Archive of monthly raw data can be found here: /hive/users/qateam/assemblyStatsCronArchive/')

get_ipython().system(u" mkdir /hive/users/qateam/assemblyStatsCronArchive/'$lastMonthFormat'")
get_ipython().system(u" cp /hive/users/'$user'/ErrorLogsOutput/* /hive/users/qateam/assemblyStatsCronArchive/'$lastMonthFormat'")
