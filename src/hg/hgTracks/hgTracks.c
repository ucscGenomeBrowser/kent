...
static char const rcsid[] = "$Id: hgTracks.c,v 1.594.2.1 2003/09/18 18:31:17 heather Exp $";
...
if (cgiVarExists("hgt.reset"))
    resetVars();
cartHtmlShell("UCSC Genome Browser v35", doMiddle, hUserCookie(), excludeVars, NULL);
return 0;
}
