/* gsidSubj3 - A CGI script to display the subject details page.. */
/* for V3 data */
#include "common.h"
#include "linefile.h"
#include "hash.h"
...
errAbort(
  "gsidSubj3 - A CGI script to display the subject details page.\n"
  "usage:\n"
  "   gsidSubj3 cgi-vars in var=val format\n"
  "options:\n"
...
static char *rootDir = "gsidSubj3Data";
...
puts("<FORM ACTION=\"/cgi-bin/gsidSubj3\" NAME=\"mainForm\" METHOD=\"GET\">\n");
