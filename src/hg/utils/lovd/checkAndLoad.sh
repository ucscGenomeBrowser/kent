...
$KENTBIN/hgLoadBed hg19 lovd lovd.hg19.bed -tab -sqlTable=../bedDetail4.sql -renameSqlTable -noBin
$KENTBIN/hgLoadBed hg18 lovd lovd.hg18.bed -tab -sqlTable=../bedDetail4.sql -renameSqlTable -noBin
