...
(
    ...
    uint   regStart[numRegions]; "starting coordinates of significant regions in this contig (see example below)"
    uint   regLength[numRegions];"length (in bases) of each significant regions sequence-count for each significant region"
    uint   regCount[numRegions]; "reads-count for each significant region"
