/* atom.c was originally generated by the autoSql program, which also 
 * generated atom.h and atom.sql.  This module links the database and
...
static char const rcsid[] = "$Id: atomDb.c,v 1.1 2007/06/21 23:13:23 braney Exp $";
