...
# 32 cluster jobs, 16 threads each --> 1/2 capacity of ku cluster.  (for many hours)
jobCount=32
threadCount=16
...
pbOut=\$3
log=\$4
/cluster/home/angie/github/usher/build/usher -u -T $threadCount -A -e 5 -v \$vcf -i \$pbIn -o \$pbOut >& \$log
EOF
