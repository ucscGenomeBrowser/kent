/* hgExpDistance_fq1 - Create table that measures expression distance between 
   ...
   thread to write distances to the filehandle - no defined queue element */
#include "common.h"
#include "linefile.h"
#include "hash.h"
#include "synQueue.h"
...
static char const rcsid[] = "$Id: hgExpDistance_fq1.c,v 1.1 2008/08/11 16:28:25 lslater Exp $";
