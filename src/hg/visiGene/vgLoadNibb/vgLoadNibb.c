...
static char const rcsid[] = "$Id: vgLoadNibb.c,v 1.4 2005/11/11 16:51:05 kent Exp $";
...
fprintf(f, "contributor Ueno N.,Kitayama A.,Terasaka C.,Nomoto K.,Shibamoto K.,Hiroyo N.\n");
fprintf(f, "year 2005\n");
