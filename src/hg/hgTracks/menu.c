...
appendLinkWithOnclick(&links, "#", "Remove all highlights", "cleaerHighlightLink", "Remove all active highlights", "highlightCurrentPosition('clear'); $('ul.nice-menu li ul').hide();", "h c", FALSE, FALSE);
