...
static char const rcsid[] = "$Id: hgTracks.c,v 1.514 2003/05/13 17:38:28 heather Exp $";
...
if (cgiVarExists("hgt.reset"))
    resetVars();
zooSpeciesHashInit();
cartHtmlShell("UCSC Genome Browser v21-alpha", doMiddle, hUserCookie(), excludeVars, NULL);
return 0;
}
