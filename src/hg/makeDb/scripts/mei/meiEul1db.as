...
string  subGroups;        "L1HS sub-group(s)|Comma-separated set (L1-Ta, L1-pre-Ta, Ta-0, Ta-1, unknown)"
string  integrity;        "Integrity|Comma-separated set (full-length, 5prime-truncated, 3prime-truncated, internal_fragment, unknown)"
...
lstring sampleTable;      "Contributing samples|HTML table (SRIP, sample, study, lineage, integrity, sub-group, PCR)"
)
