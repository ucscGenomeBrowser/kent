/* output/newTest.c was originally generated by the autoSql program, which also 
 * generated output/newTest.h and output/newTest.sql.  This module links the database and
