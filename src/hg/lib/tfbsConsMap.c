 ...
 * If worried about this use tfbsConsMapSaveToDbEscaped() */
{
...
void tfbsConsMapSaveToDbEscaped(struct sqlConnection *conn, struct tfbsConsMap *el, char *tableName, int updateSize)
/* Save tfbsConsMap as a row to the table specified by tableName. 
 * As blob fields may be arbitrary size updateSize specifies the approx size.
 * of a string that would contain the entire query. Automatically 
 * escapes all simple strings (not arrays of string) but may be slower than tfbsConsMapSaveToDb().
