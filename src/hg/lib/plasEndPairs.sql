# plasEndPairs.sql was originally generated by the autoSql program, which also 
# generated plasEndPairs.c and plasEndPairs.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#Standard linked features series table
CREATE TABLE plasEndPairs (
