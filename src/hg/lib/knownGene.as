...
uint    cdsStart;           "Coding region start (or end position if for minus strand item); cdsStart == cdsEnd for non-coding transcripts"
uint    cdsEnd;             "Coding region end (or start position if for minus strand item); cdsStart == cdsEnd for non-coding transcripts"
