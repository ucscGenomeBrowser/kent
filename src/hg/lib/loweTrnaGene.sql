# loweTrnaGene.sql was originally generated by the autoSql program, which also 
# generated loweTrnaGene.c and loweTrnaGene.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#Information for a tRNA gene annotated by Todd Lowe
CREATE TABLE loweTrnaGene (
