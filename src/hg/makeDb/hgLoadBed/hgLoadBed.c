...
while (lineFileNextReal(lf, &line))
	...
	errAbort("ERROR: number of input data lines over limit: %s\n\nSee also:\n<a href='http://genome.ucsc.edu/goldenPath/help/bigWig.html' target=_blank>bigWig help</a> for converting large bedGraph files using bedGraphToBigWig\n<a href='http://genome.ucsc.edu/goldenPath/help/bigBed.html' target=_blank>bigBed help</a> for converting large bed files using bedToBigBed\n<a href='http://genome.ucsc.edu/goldenPath/help/hgTrackHubHelp.html#Hosting' target=_blank>trackHub help</a> for bigDataUrl data hosting solutions", commaString);
	}
    if (hasBin)
	nextWord(&line);
