/* cdwWebAuthLogin - A tiny little program to help manage Persona logins.  Specifically
...
{
errAbort(
  "cdwWebAuthLogin - A tiny little program to help manage Persona logins.\n"
