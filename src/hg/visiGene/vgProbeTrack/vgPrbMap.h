 ...
 * If worried about this use vgPrbMapSaveToDbEscaped() */

void vgPrbMapSaveToDbEscaped(struct sqlConnection *conn, struct vgPrbMap *el, char *tableName, int updateSize);
/* Save vgPrbMap as a row to the table specified by tableName. 
 * As blob fields may be arbitrary size updateSize specifies the approx size.
 * of a string that would contain the entire query. Automatically 
 * escapes all simple strings (not arrays of string) but may be slower than vgPrbMapSaveToDb().
