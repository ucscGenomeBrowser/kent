...
if ( -e GitReports.ok ) then
    ...
    echo "Ready for pairings, day 16, Git reports completed for v${BRANCHNN} branch http://genecats.soe.ucsc.edu/git-reports/ (history at http://genecats.soe.ucsc.edu/git-reports-history/)." | mail -s "Ready for pairings (day 16, v${BRANCHNN} review)." ${BUILDMEISTEREMAIL} kuhn@soe.ucsc.edu brianlee@soe.ucsc.edu azweig@ucsc.edu kate@soe.ucsc.edu chmalee@ucsc.edu jnavarr5@ucsc.edu
