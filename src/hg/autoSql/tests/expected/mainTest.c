/* output/mainTest.c was originally generated by the autoSql program, which also 
 * generated output/mainTest.h and output/mainTest.sql.  This module links the database and
