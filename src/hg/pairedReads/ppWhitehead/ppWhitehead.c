...
static char const rcsid[] = "$Id: ppWhitehead.c,v 1.2 2003/05/06 07:22:33 kate Exp $";
...
void ppWhitehead(char *headersName, char *sizesName, char *pairsPsl, 
...
if (argc != 7)
    usage();
ppWhitehead(argv[1], argv[2], argv[3], argv[4], argv[5], argv[6]);
return 0;
}
