# uPennClones.sql was originally generated by the autoSql program, which also 
# generated uPennClones.c and uPennClones.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#Clones positioned on the assembly by U Penn (V. Cheung)
CREATE TABLE uPennClones (
