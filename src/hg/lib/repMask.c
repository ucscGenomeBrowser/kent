...
fputc(sep,f);
fprintf(f, "%f", el->percDiv, sep);
fputc(sep,f);
fprintf(f, "%f", el->percDel, sep);
fputc(sep,f);
fprintf(f, "%f", el->percInc, sep);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->qName, sep);
if (sep == ',') fputc('"',f);
fputc(sep,f);
fprintf(f, "%d", el->qStart, sep);
fputc(sep,f);
fprintf(f, "%d", el->qEnd, sep);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->qLeft, sep);
if (sep == ',') fputc('"',f);
fputc(sep,f);
if (sep == ',') fputc('"',f);
...
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->rName, sep);
if (sep == ',') fputc('"',f);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->rFamily, sep);
if (sep == ',') fputc('"',f);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->rStart, sep);
if (sep == ',') fputc('"',f);
fputc(sep,f);
fprintf(f, "%u", el->rEnd, sep);
fputc(sep,f);
if (sep == ',') fputc('"',f);
fprintf(f, "%s", el->rLeft, lastSep);
if (sep == ',') fputc('"',f);
fputc(lastSep,f);
}
