...
"This describe the fields of returned by mysql's show table status"
    ...
    uint dataLength;	"Size of data in table"
    uint maxDataLength; "Maximum data length for this table type"
    uint indexLength;	"Length of index in bytes"
    uint dataFree;	"Usually zero"
    uint autoIncrement; "Current value of autoincrement - often rows+1"
