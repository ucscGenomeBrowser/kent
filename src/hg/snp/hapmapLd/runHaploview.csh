...
# $Id: runHaploview.csh,v 1.1 2007/10/29 23:47:39 angie Exp $
...
set c = `echo $txtFile | perl -wpe 's/^genotypes_chr([0-9MXY]+)_.*/$1/ || die "Cant parse chrom out of filename '$txtFile'";'`
