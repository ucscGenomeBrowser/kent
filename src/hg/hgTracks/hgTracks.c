...
static char const rcsid[] = "$Id: hgTracks.c,v 1.589.2.1 2003/09/04 17:13:59 heather Exp $";
...
if (cgiVarExists("hgt.reset"))
    resetVars();
cartHtmlShell("UCSC Genome Browser v33", doMiddle, hUserCookie(), excludeVars, NULL);
return 0;
}
