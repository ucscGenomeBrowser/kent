...
echo "Ready for pairings, day 9, Git reports completed for v${NEXTNN} preview2 http://genecats.cse.ucsc.edu/git-reports/ (history at http://genecats.cse.ucsc.edu/git-reports-history/)." | mail -s "Ready for pairings (day 9, v${NEXTNN} preview2)." $USER@soe.ucsc.edu ${BUILDMEISTER}@soe.ucsc.edu kuhn@soe.ucsc.edu ann@soe.ucsc.edu kate@soe.ucsc.edu luvina@soe.ucsc.edu braney@soe.ucsc.edu steve@soe.ucsc.edu
