# encodeErgeHssCellLines.sql was originally generated by the autoSql program, which also 
# generated encodeErgeHssCellLines.c and encodeErgeHssCellLines.h.  This creates the database representation of
# an object which can be loaded and saved from RAM in a fairly 
# automatic way.

#ENCODE experimental data from dbERGEII
CREATE TABLE encodeErgeHssCellLines (
    ...
    allLines varchar(255) not null,	# List of all cell lines
              #Indices
#    PRIMARY KEY(chrom)
INDEX(chrom(8),bin)
#       UNIQUE(id(10))
