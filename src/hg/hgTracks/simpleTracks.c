...
registerTrackHandler("joinedRmsk", jRepeatMethods);
registerTrackHandler("rmskJoinedBaseline", jRepeatMethods);
registerTrackHandler("rmskJoinedCurrent", jRepeatMethods);
