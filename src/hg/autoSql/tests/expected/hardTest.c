/* output/hardTest.c was originally generated by the autoSql program, which also 
 * generated output/hardTest.h and output/hardTest.sql.  This module links the database and
